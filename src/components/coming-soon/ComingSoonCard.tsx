  ...
  if (minimized) {
    return (
      <button
        ...
        className="focus-ring shadow-hard mx-auto flex items-center gap-2 border-2 border-orb-black bg-orb-white px-4 py-2 font-display text-xs font-bold uppercase tracking-wide"
      >
  ...
  return (
    <div className="relative w-full">
      <Win95Window title="cartel.txt — orbitando" onMinimize={() => setMinimized(true)}>
        <div className="relative bg-orb-black px-6 py-8 md:px-10 md:py-10">
          <ColorLabel
            text="Próximamente"
            color="magenta"
        ...
        <div className="flex flex-col items-center px-5 py-6 text-center md:px-8 md:py-8">
          <p className="font-display text-[10px] font-bold uppercase tracking-[0.22em] text-orb-black/50">
            Transmisión 001
          </p>
          ...
          <p className="mt-4 max-w-sm text-base text-orb-black/80 md:text-lg">
